...
class Polls(commands.Cog):
    ...
    async def poll(self, ctx, *, question):
        """Интерактивное создание опросов, используйте реакции, чтобы голосовать
        """
        ...
        for i in range(20):
            messages.append(await ctx.send(f'Напишите варианты опроса или {ctx.prefix}cancel для публикации опроса.'))
